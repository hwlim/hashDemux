...
DimPlot(seurat_object,group.by = "clustering_based", label = T) 
...
cluster_heatmap= Heatmap( mtrx2 , cluster_columns = F, cluster_rows = F,col = col_fun,
...
htodemux_heatmap + cluster_heatmap
```
