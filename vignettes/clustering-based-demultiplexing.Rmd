...
This vignette provides a brief introduction on how to run the clustering-based demultiplexing workflow for single-cell sample multiplexing experiments. This workflow takes as input tag counts matrix with tags as
...
```{r, message=FALSE, fig.dim = c(12, 7)}
